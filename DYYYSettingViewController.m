...
- (void)setupSettingItems {
    self.settingSections = @[
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"隐藏点赞数值" key:@"DYYYHideLikeBLabel" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隐藏视频上方搜索" key:@"DYYYHideVideoTopSearch" type:DYYYSettingItemTypeSwitch],
